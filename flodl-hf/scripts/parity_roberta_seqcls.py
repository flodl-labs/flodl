#!/usr/bin/env python3
"""Generate the parity fixture for `RobertaForSequenceClassification`.

Runs HuggingFace `RobertaForSequenceClassification` on a pinned text
input and writes both the tokenised inputs and the reference logits to
`flodl-hf/tests/fixtures/roberta_seqcls_parity.safetensors`.
...
FIXTURE_PATH = (
    ...
    / "tests" / "fixtures" / "roberta_seqcls_parity.safetensors"
)
