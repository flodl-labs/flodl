#!/usr/bin/env python3
"""Generate the parity fixture for `RobertaForQuestionAnswering`.

Runs HuggingFace `RobertaForQuestionAnswering` on a pinned
(question, context) pair and writes inputs + `[B, S, 2]` start/end
logits to `flodl-hf/tests/fixtures/roberta_qa_parity.safetensors`.
