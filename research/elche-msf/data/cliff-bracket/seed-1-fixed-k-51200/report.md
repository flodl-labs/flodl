...
|------|------|------|--------|-----------|-------|--------------|------|------|----------|
| nccl-async | 0.483570 | 0.1002 | -0.8123 | 1707.0 | 1 | 0.0 | 100% | 100% | 4.7 |
...
|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|
| nccl-async | 2.0327 | 0.8805 | 0.6705 | 0.6107 | 0.5769 | 0.5578 | 0.5391 | 0.5353 | 0.5178 | 0.5088 | 0.5025 | 0.4925 | 0.4965 | 0.4832 | 0.4886 | 0.4928 | 0.4853 | 0.4791 | 0.4822 | 0.4836 |
...
|-------|------|------|--------|-------|----------------|
| resnet-graph | nccl-async | 0 | cuda:0 | 0.3758 | 3.2 |
| resnet-graph | nccl-async | 1 | cuda:1 | 0.3005 | 3.9 |
| resnet-graph | nccl-async | 2 | cuda:2 | 0.3237 | 3.4 |

## VRAM Usage

| Model | Mode | GPU0 Peak (MB) | GPU0 Mean (MB) | GPU1 Peak (MB) | GPU1 Mean (MB) |
|-------|------|---------------|---------------|---------------|---------------|
| resnet-graph | nccl-async | 356 | 355 | 374 | 372 |
...
|------|-----|-----------|-------------|-------|
| nccl-async | gpu2 | 1705.9 | 1.0 | epoch-boundary(199) |
| nccl-async | gpu1 | 1706.0 | 0.9 | epoch-boundary(199) |
...
|-------|------|------------|------------|
| resnet-graph | nccl-async | 127.2 | 7.5% |
